...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'ajay.ai.analyst@gmail.com',
    href: 'mailto:ajay.ai.analyst@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 76038 24812',
  ...
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/ajay-c-03a707286',
    href: 'https://www.linkedin.com/in/ajay-c-03a707286/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Ajaychinnadurai',
    href: 'https://github.com/Ajaychinnadurai',
  },
];
